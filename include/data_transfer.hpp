...
class put : public multipart_method {
    private:
        off_t offset_;
        irods::file_object_ptr file_obj_;
    public:
    ...
    virtual size_t client_transfer(
        ...
        irods::message_broker::data_type chunk_to_send(_bytes_remaining > _block_size ?
                _block_size :
                _bytes_remaining);
    ...
    virtual size_t server_transfer(
        ...
        if (static_cast<size_t>(_uni_req.bytes_to_transfer) == _bytes_remaining) {
            ...
            file_obj_ = boost::make_shared<irods::file_object>(
                    _comm,
...
class get : public multipart_method {
    ...
    virtual size_t server_transfer(
        ...
        irods::message_broker::data_type snd_msg(_bytes_remaining > _block_size ?
                _block_size :
                _bytes_remaining);
